...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.karmakurier.backend.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.karmakurier.backend.repository.UserRepository.USERS_BY_EMAIL_CACHE);
