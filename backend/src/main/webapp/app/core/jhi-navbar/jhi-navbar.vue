    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">karmakurier</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/mission">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.mission')">Mission</span>
                    </b-dropdown-item>
